...
namespace MongoDB.AspNetCore.Identity
{
        ...
        where TUser: IdentityUser
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="MongoUserStore{TUser}" /> class.
        ///     Takes a mongoDB conecction string with the database name included
        /// </summary>
        /// <param name="connectionString">The connection name or URL.</param>
        public MongoUserStore(string connectionString)
        {
            db = GetDatabaseFromUrl(new MongoUrl(connectionString));
            userCollection = db.GetCollection<TUser>(typeof(TUser).Name);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="MongoUserStore{TUser}"/> class using a already initialized IMongoDatabase interface.
        /// </summary>
        /// <param name="mongoDatabase">The mongo database.</param>
        public MongoUserStore(IMongoDatabase mongoDatabase)
        {
            db = mongoDatabase;
            userCollection = db.GetCollection<TUser>(typeof(TUser).Name);
        }
        ...
        public async virtual Task<IdentityResult> UpdateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var filter = Builders<TUser>.Filter.Eq("_id", ObjectId.Parse(user.Id));
        ...
        public virtual Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            var filter = Builders<TUser>.Filter.Eq("_id", ObjectId.Parse(userId));
            TUser user = userCollection.Find(filter).FirstOrDefault();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public virtual Task AddToRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (user == null)
            ...
            if (!user.Roles.Contains(normalizedRoleName, StringComparer.CurrentCultureIgnoreCase))
        ...
        public virtual Task RemoveFromRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            user.Roles.RemoveAll(r => String.Equals(r, normalizedRoleName, StringComparison.CurrentCultureIgnoreCase));
            return Task.FromResult(0);
        }
        ...
        public virtual Task<bool> IsInRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Task.FromResult(user.Roles.Contains(normalizedRoleName, StringComparer.CurrentCultureIgnoreCase));
        }
        ...
        public async virtual Task<IList<TUser>> GetUsersInRoleAsync(string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await userCollection.Find(u => u.Roles.Any(r => r == normalizedRoleName)).ToListAsync();
        }
        ...
        public async virtual Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await userCollection.Find(u => u.Claims.Any(c => c.ClaimValue == claim.Type && c.ClaimType == claim.Type)).ToListAsync();
        }
        ...
        public virtual Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            IList<UserLoginInfo> userLoginInfo = user.Logins.ToList();
            return Task.FromResult(userLoginInfo);
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return await userCollection.Find(u => u.Logins.Any(l => l.LoginProvider == loginProvider && l.ProviderKey == providerKey)).FirstOrDefaultAsync();
        }
        ...
        public async virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return await userCollection.Find(u => u.NormalizedEmail == normalizedEmail).FirstOrDefaultAsync();
        }
